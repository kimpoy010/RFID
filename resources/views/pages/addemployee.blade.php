...
@section('stylesheets')
	<link rel="stylesheet" type="text/css" href="{{ asset('css/addemployee.css') }}">
@endsection

@section('content')
  	<div class="row">
	  	<form method="POST" action="{{ route('save.employee') }}" data-parsley-validate enctype="multipart/form-data" content="text/html; charset=utf-8">
	  		<div class="col-md-12">
	  		...
	  		<div class="col-md-4">
	  			...
	  			<div class="form-group">
	  				<label for="std_number">Employee No:</label><span id="std_number-error"> </span>
	  			...
	  			<div class="form-group">
	  				<label for="address">Contact Number:</label> <span id="cnt-error"></span>
	  				<input type="tel" maxlength="11" name="contact_number" class="form-control" required data-parsley-required-message="Please enter your contact number!" data-parsley-errors-container="#cnt-error">
	  			</div>
	  		</div>
	  		<div class="col-md-4">
	  			<div class="form-group">
	  				<label for="guardian_name">Employee Category:</label> <span id="emp_ategory-error"></span>
	  				<select name="employee_category" id="emp_ategory" class="form-control" required data-parsley-required-message="Please select employee category" data-parsley-errors-container="#emp_ategory-error">
	  			...
	  			<div class="form-group">
	  				...
	  				<input type="text" name="designation" class="form-control capitalize" required data-parsley-required-message="Please enter the designation!" data-parsley-errors-container="#designation-error">
	  			</div>
	  			...
	  			<div class="form-group">
	  				<label for="guardian_name">Contact Name:</label> <span id="guardian_name-error"></span>
	  			...
	  			<div class="form-group">
	  				<label for="address">Address:</label> <span id="address-error"></span>
	  				<input type="text" name="guardian_address" class="form-control" required data-parsley-required-message="Please enter the address!" data-parsley-errors-container="#address-error">
	  			</div>
	  			<div class="form-group">
	  				<label for="contact_number">Contact Number:</label> <span id="contact_number-error"></span>
	  				<input type="tel" maxlength="11" name="guardian_number" class="form-control" required data-parsley-required-message="Please enter the 11-digit contact number!" data-parsley-errors-container="#contact_number-error" placeholder="09051234567">
	  			</div>
	  		</div>
	  		...
	  		<div class="col-md-4">
	  			...
	  			<div class="text-center btn-photo">
	  				<label for="std_photo" class="btn btn-info ">
	  					<input type="file" name="file" id="std_photo" data-parsley-required-message="Please select a photo!" data-parsley-errors-container="#photo-error" accept="image/gif, image/jpeg, image/png">
	  					Add Employee Photo
	  				</label>
	  			...
	  			<div class="buttons text-center">
	  				<button class="btn btn-success" type="submit"><i class="fa fa-plus"></i> Add New Employee</button>
